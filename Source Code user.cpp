...
void User::on_logoutButton_clicked() // Slot untuk tombol logout yang diklik.
{
    SiInventaris *login = new SiInventaris(); // Membuat objek SiInventaris
    login->show(); // Menampilkan login
    this->close(); // Menutup jendela user
}
